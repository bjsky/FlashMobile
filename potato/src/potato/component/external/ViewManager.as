...
//		public static var rootPath:String = "";//默认在resource/如果view复制粘贴的其他目录下。要更改这个属性
//		public static var rootPath:String = "resource/";//默认在resource/如果view复制粘贴的其他目录下。要更改这个属性
		
//		public static var commonPath:String = "common";//通用资源目录  默认是common
//		
//		public static var pic_cfg_path:String = "pic_cfg/pic_cfg.txt";
...
//			var res:Res=new Res();
//			res.appendCfg("pic_cfg/pic_cfg.txt",true);
//			res.appendCfg("view_cfg/view_cfg.txt",true);
			
//			data.assetsUrl=rootPath+data.assetsUrl;
//			data.configUrl=rootPath+data.configUrl;
//			
...
//				res.appendCfgBean("arrow_0.png","resource/arrow_0.png","",0,1,9,9);
//				
//			}
			
			//预览的时候用
//			var assetsUrl:String = "pre_resource/prev.png";
//			var configUrl:String = "pre_resource/prev.xml";
//			if(File.exists(assetsUrl))
//			{
//				var assetsName:String=configUrl.substr(assetsUrl.lastIndexOf("/")+1);
//				assetsName=assetsName.substr(0,assetsName.indexOf("."));
//				var preRes:Res=new Res();
//				preRes.appendCfgBean(assetsName,assetsUrl,configUrl,0,1,1,7);
//			}
			
			
//			if(File.exists(pic_cfg_path))
//			{
//				var res:Res = new Res();
//				var fileInfo:String = File.read(pic_cfg_path);
//				var picRow:Array = fileInfo.split(/\r\n|\r|\n/);
//				for(var i:int=1;i<picRow.length;i++)
//				{
////					trace("=i="+i+"=value="+picRow[i]);
////					trace("===id=="+picRow[i].split("\t")[0]+"===path==="+picRow[i].split("\t")[1]);
//					res.appendCfgBean(picRow[i].split("\t")[0]+".png",picRow[i].split("\t")[1],"",0,1,9,9);
//				}
//			}
