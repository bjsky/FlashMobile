package potato.editor.layoutUI
{
	...
	{
		public function ButtonUI(skins:*=null, text:String="", width:Number=NaN, height:Number=NaN, textformat:TextFormat=null, textPadding:Padding=null, toggleEnable:Boolean=false)
		{
			_layout=new LayoutElement(this);
			super(skins, text, width, height, textformat, textPadding, toggleEnable);
		}
