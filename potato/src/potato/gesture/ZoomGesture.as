package potato.gesture
{
	 ...
	 * 
	 */
	[Event(name="zoomBegin",type="potato.gesture.GestureEvent")]
	/**
	 * 缩放过程中.
	 * @author liuxin
	 * 
	 */
	[Event(name="zoom",type="potato.gesture.GestureEvent")]
	/**
	 * 缩放结束.
	 * @author liuxin
	 * 
	 */
	[Event(name="zoomEnd",type="potato.gesture.GestureEvent")]
	/**
	 * 缩放手势.
