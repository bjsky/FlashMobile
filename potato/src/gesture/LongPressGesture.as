package potato.gesture
{
	 ...
	 * 
	 */
	[Event(name="longPressEnd",type="potato.event.GestureEvent")]
	/**
	 * 长按中事件.
	 * @author liuxin
	 * 
	 */
	[Event(name="longPressUpdate",type="potato.event.GestureEvent")]
	/**
	 * 长按开始事件.
	 * @author liuxin
	 * 
	 */
	[Event(name="longPressBegin",type="potato.event.GestureEvent")]
	/**
	 * 长按手势.
