package potato.component.controller
{
	 ...
	 * 
	 */	
	public class AreaEaseingPanController extends AreaPanController
	{
		 ...
		 * 
		 */		
		public function AreaEaseingPanController(minWidth:Number=0, minHeight:Number=0, maxWidth:Number=0, maxHeight:Number=0)
		{
			super(minWidth, minHeight, maxWidth, maxHeight);
		}
		/**
		 *当按下容器时，清空数据，停止所有缓动 。 
		 * @param pan
