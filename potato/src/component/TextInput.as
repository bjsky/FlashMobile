package potato.component
{
	...
	/**
	 * 输入框.
	 * <p>设置宽高时，输入框大小由宽高决定。否则由背景大小和文字填充决定。
	 * 当输入框为多行文本时，设置maxLine有助于提高输入框性能，否则输入框依据文字内容是否超出显示范围自动换行</p>
	 * <p>输入框始终没有焦点，输入内容在最后追加或者删除</p>
	 * @author liuxin
	 * 
	 */
...
//			trace("input______");
		...
		protected function renderMutiLineText():void{
			...
			if(complete)
				...
				_textField.scrollV=_textField.numLines-size.numLines+2;
		}
